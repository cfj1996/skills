...
| Same paused run receives only “继续” | Keep the paused artifact and request the resolver's missing evidence/confirmation. Do not reinterpret “继续” as authorization or advance the chain. |
...
| A capability result changes after a pause | Retain the old artifact as evidence, resume from its owning capability with the explicit new information, and wait for its new eligible handoff before downstream work. |
