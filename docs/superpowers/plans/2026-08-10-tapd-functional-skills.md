...
- Submission supports exactly `STANDARD` and `NO_WIKI`; `STANDARD` reuses `drafting-wiki`, while `NO_WIKI` records `SKIPPED_BY_POLICY` and does not invoke it.
...
### Task 1: Implement `preparing-work`

**Files:**
- Create: `plugins/zan-workflows/skills/preparing-work/SKILL.md`
- Create: `plugins/zan-workflows/skills/preparing-work/agents/validator.md`
- Create: `plugins/zan-workflows/skills/preparing-work/references/contracts.md`
- Create: `plugins/zan-workflows/skills/preparing-work/references/collection-and-resume.md`
- Create: `plugins/zan-workflows/skills/preparing-work/references/acceptance-scenarios.md`
...
- [ ] **Step 2:** Create the skill with frontmatter name `preparing-work` and a `Use when...` description covering TAPD understanding, scoping, routing, constraints and resumption.
...
- [ ] **Step 5:** Replay GREEN; expect a verified target or explicit block and no edit. Run `quick_validate.py plugins/zan-workflows/skills/preparing-work`.

### Task 2: Implement `implementing-work`

**Files:**
- Create: `plugins/zan-workflows/skills/implementing-work/SKILL.md`
- Create: `plugins/zan-workflows/skills/implementing-work/agents/change-reviewer.md`
- Create: `plugins/zan-workflows/skills/implementing-work/references/contracts.md`
- Create: `plugins/zan-workflows/skills/implementing-work/references/development-rules.md`
- Create: `plugins/zan-workflows/skills/implementing-work/references/acceptance-scenarios.md`
...
- [ ] **Step 2:** Create `implementing-work`; keep status transition, actual project verification, branch/worktree setup, exact-path confirmation, Superpowers planning, TDD, evidence and private review together.
...
- [ ] **Step 5:** Replay GREEN; expect pre-edit blocking or a fully reviewed result. Run `quick_validate.py plugins/zan-workflows/skills/implementing-work`.

### Task 3: Implement `drafting-wiki`

**Files:**
- Create: `plugins/zan-workflows/skills/drafting-wiki/SKILL.md`
- Create: `plugins/zan-workflows/skills/drafting-wiki/agents/wiki-validator.md`
- Create: `plugins/zan-workflows/skills/drafting-wiki/references/contracts.md`
- Create: `plugins/zan-workflows/skills/drafting-wiki/references/wiki-template.md`
- Create: `plugins/zan-workflows/skills/drafting-wiki/references/acceptance-scenarios.md`
...
- [ ] **Step 2:** Create `drafting-wiki`; preserve noncritical gaps as `待补充`, block critical contradictions, and produce copyable Markdown only after private semantic validation.
...
- [ ] **Step 5:** Replay GREEN; expect no write and directly copyable output. Run `quick_validate.py plugins/zan-workflows/skills/drafting-wiki`.

### Task 4: Implement `submitting-for-test`

**Files:**
- Create: `plugins/zan-workflows/skills/submitting-for-test/SKILL.md`
- Create: `plugins/zan-workflows/skills/submitting-for-test/agents/submission-validator.md`
- Create: `plugins/zan-workflows/skills/submitting-for-test/references/contracts.md`
- Create: `plugins/zan-workflows/skills/submitting-for-test/references/submission-rules.md`
- Create: `plugins/zan-workflows/skills/submitting-for-test/references/acceptance-scenarios.md`
...
- [ ] **Step 5:** Replay both GREEN scenarios. Run `quick_validate.py plugins/zan-workflows/skills/submitting-for-test`.

### Task 5: Implement `going-live`

**Files:**
- Create: `plugins/zan-workflows/skills/going-live/SKILL.md`
- Create: `plugins/zan-workflows/skills/going-live/agents/master-merge-validator.md`
- Create: `plugins/zan-workflows/skills/going-live/references/contracts.md`
- Create: `plugins/zan-workflows/skills/going-live/references/acceptance-scenarios.md`
...
- [ ] **Step 2:** Create `going-live`; require the original repair branch, actual commit display, authorization, merge/readback and optional existing-Wiki mark/readback.
...
- [ ] **Step 5:** Replay GREEN. Run `quick_validate.py plugins/zan-workflows/skills/going-live`.

### Task 6: Implement `fixing-bug` and retire the plugin monolith

**Files:**
- Create: `plugins/zan-workflows/skills/fixing-bug/SKILL.md`
- Create: `plugins/zan-workflows/skills/fixing-bug/references/contracts.md`
- Create: `plugins/zan-workflows/skills/fixing-bug/references/workflow.md`
- Create: `plugins/zan-workflows/skills/fixing-bug/references/acceptance-scenarios.md`
...
- [ ] **Step 2:** Create `fixing-bug`; require the five capability skills by name, pass contracts and constraints, stop on blocks/authorization, route resumes by `pause.capability`, reuse unchanged prefix artifacts, invalidate only an affected suffix, and invoke master merge only when requested.
- [ ] **Step 3:** Keep cleanup/final reporting at the orchestration boundary and do not reproduce capability rules.
- [ ] **Step 4:** Delete only the plugin `tapd-workflow`, add composition scenarios, replay GREEN and run `quick_validate.py plugins/zan-workflows/skills/fixing-bug`.
