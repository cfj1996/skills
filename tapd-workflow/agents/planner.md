...
- **Consult User**: Ask for the target branch (base branch). Default is `origin/master`.
- **Branch naming rule**: {Chinese Description}-{ID} (e.g., 用户登录修复-1001234), unless the user specifies otherwise.
